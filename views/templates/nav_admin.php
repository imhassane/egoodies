	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav ml-auto">
				...
				<li>
					<a class="nav-link" href="<?= base_url() . "index.php/articles/" ?>">Actualités</a>
				</li>
				<li class="nav-item">
				...
				<li class="dropdown">
					...
					<div class="dropdown-menu">
						<a class="dropdown-item" href="<?= base_url() . "index.php/member/espaceadmin" ?>">Espace administrateur</a>
